import re
from provided.generator_utils import encode, SPARQL_KEYWORDS
...
def preprocesser(english_file, sparql_file, output_prefix):

    with open(output_prefix + ".en", "w", encoding="utf-8") as out:
    ...
    with open(output_prefix + ".sparql", "w", encoding="utf-8") as out:
